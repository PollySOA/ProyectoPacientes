...
CREATE TABLE `paciente_medicamento` (
  ...
  KEY `FK5rb1b57mlg7nr3g8gbi46q59h` (`idmedicamento`),
  CONSTRAINT `FK5rb1b57mlg7nr3g8gbi46q59h` FOREIGN KEY (`idmedicamento`) REFERENCES `medicamento` (`id_medicamento`),
  CONSTRAINT `FK6hwro1a2lyec2bixwmuy5ewvw` FOREIGN KEY (`idpaciente`) REFERENCES `paciente` (`id_paciente`)
